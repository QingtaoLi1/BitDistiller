...
---
Forked from [DD-DuDa/BitDistiller](https://github.com/DD-DuDa/BitDistiller). This repo:
1. ✅Fixes some environment issues, and upgrades packages to `transformers==4.51.3` which supports Qwen3 models.
2. ✅Includes lighteval for a wider range of benchmark evaluation via [OpenR1](https://github.com/QingtaoLi1/open-r1/tree/78384abae780c00f6f0b692defb4bcd9d421c675).
3. ✅Provides scripts for convenient Singularity cluster running.
4. 🕐[To-be-checked] Adds RL running via [OpenR1](https://github.com/QingtaoLi1/open-r1/tree/78384abae780c00f6f0b692defb4bcd9d421c675).
---
